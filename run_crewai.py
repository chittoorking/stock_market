"""
Run CrewAI debate pipeline on 6-month data.
Bull vs Bear debate with full reasoning trace.

Usage:
    python run_crewai.py                    # Last 10 days
...
print(f'  CrewAI debate (this run):     {wins/n:.0%} WR, {total:+.3f}%')
